...
function cliWork() {
    return __awaiter(this, void 0, void 0, function () {
        var args, saveTo, pictures, _i, pictures_1, picture, stats, pptxFileName, extension, native, author, title, revision, createdAt, settings, service, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    service = new PptxGenerationService_1.default(settings.saveTo, settings.pictures, settings.pptxFileName, settings.extension, settings.native, settings.meta);
