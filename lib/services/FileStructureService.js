...
var readdir = fs_1.promises.readdir, mkdtemp = fs_1.promises.mkdtemp;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.native) return [3 /*break*/, 2];
                        return [4 /*yield*/, ((_a = this.command) === null || _a === void 0 ? void 0 : _a.copy(sharedDir + '/.', this.tempPath))];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, utils_1.ncpCopy(sharedDir, this.tempPath)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, mkdtemp(path_1.join(this.workingDirectory, 'pres.pptx.'))];
                    case 1:
                        _a.tempPath = _b.sent();
