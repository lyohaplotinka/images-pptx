...
var PptxGenerationService = /** @class */ (function () {
     ...
     * @param meta
     */
    function PptxGenerationService(workingDirectory, filePatterns, outFile, extension, native, meta) {
    ...
    PptxGenerationService.prototype.generatePresentationMeta = function () {
        var _a, _b, _c, _d, _e;
        return __awaiter(this, void 0, void 0, function () {
            var locals;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        locals = {
                            presentation: {
                                title: ((_a = this.meta) === null || _a === void 0 ? void 0 : _a.title) || 'Images-pptx presentation',
                                author: ((_b = this.meta) === null || _b === void 0 ? void 0 : _b.author) || 'Images-pptx',
                                createdAt: ((_c = this.meta) === null || _c === void 0 ? void 0 : _c.createdAt) || new Date().toISOString(),
                                revision: (_e = (_d = this.meta) === null || _d === void 0 ? void 0 : _d.revision) !== null && _e !== void 0 ? _e : 1,
                            },
                        };
                        return [4 /*yield*/, this.swigRenderer.renderTemplate(templates_1.default.DocPropsCoreTemplate, locals, 'core.xml')];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.fileStructure.makeRequiredStructure().catch(function (err) {
                                throw err;
                            })];
                    case 4:
                        _a.sent();
